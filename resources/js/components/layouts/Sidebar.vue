<template>
  ...
  >
    ...
    <!-- Nav Item - Charts -->
    <li class="nav-item">
      <router-link to="/multiUpload" class="nav-link">
        <i class="fas fa-fw fa-tachometer-alt"></i>
    ...
    <li class="nav-item">
      <a href="javascript:void(0)" @click.prevent="Logout()" class="nav-link">
        <i class="fas fa-fw fa-tachometer-alt"></i>
        <span>Logout</span>
      </a>
    </li>
...
export default {
  ...
  methods: {
    async Logout() {
      ...
      if (confirm("Are you sure you want to logout from this site ?")) {
